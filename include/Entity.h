...
public:
    ...
    Entity(const std::string& textureName, int ID, float x = 0, float y = 0, float speed_x = 0, float speed_y = 0);

    // Конструктор с параметрами с указание области на текстуре
    Entity(const std::string& textureName, const sf::IntRect& textureRect, int ID, float x = 0, float y = 0, float speed_x = 0, float speed_y = 0);
